...
import { TOKENS, TOKENS_TEST, TOKENS_PRIV, MAIN_NETWORK_ID, TEST_NETWORK_ID, PRIV_NETWORK_ID } from './constants'
...
export const getDefaultTokens = (): Array<TokenItemType> => {
  ...
  tokens.push(...map(TOKENS_PRIV, (scriptHash, symbol) => getTokenEntry(symbol, scriptHash, PRIV_NETWORK_ID)))
